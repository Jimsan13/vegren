...
<head>
   ...
   <style>
    ...
    .almacen-tabs .nav-link.active { /* Changed class from gastos-tabs to almacen-tabs */
        color:rgb(34, 202, 45); /* Green for active tab */
    ...
    .card-summary .icon.movement {
        color:rgb(26, 187, 56); /* Blue-green for movements */
    }
    ...
    /* Table styles for "Almacén de Venta" */
    .table-responsive {
        margin-top: 20px;
    }
    ...
    .modal-header .close {
        color: #dc3545; /* Changed to red for the close button "x" */
        opacity: 1;
    }
